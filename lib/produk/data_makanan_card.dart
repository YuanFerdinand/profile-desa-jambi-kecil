...
import 'package:profile_desa_jambi_kecil/views/detail_makanan.dart';

class DataMakananKhasCard extends StatefulWidget {
  ...
  @override
  _DataMakananKhasCardState createState() => _DataMakananKhasCardState();
}

class _DataMakananKhasCardState extends State<DataMakananKhasCard> {
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(context, MaterialPageRoute(builder: (context) {
          return DetailMakanan(widget.createdAt, widget.desk, widget.gambar,
