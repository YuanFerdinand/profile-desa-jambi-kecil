...
class AddDataKebudayaan extends StatefulWidget {
  @override
  _AddDataKebudayaanState createState() => _AddDataKebudayaanState();
}

class _AddDataKebudayaanState extends State<AddDataKebudayaan> {
  var deskController;
  var namaController;
  var imagePath;
  var imageDir;
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () async {
                                ...
                                DatabaseMethods()
                                    .addDataKebudayaan(random, addData);
                              },
                              child: Container(
                                decoration: BoxDecoration(
                                  color: Color(0xff008000),
