...
class EditDataWisata extends StatefulWidget {
  ...
  @override
  _EditDataWisataState createState() => _EditDataWisataState();
}

class _EditDataWisataState extends State<EditDataWisata> {
  var imagePath;
  var deskController;
  var namaController;
  var imageDir;
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () async {
                                ...
                                DatabaseMethods()
                                    .updateDataWisata(widget.id, updateInfo);
                              },
                              child: Container(
                                decoration: BoxDecoration(
                                  color: Color(0xff008000),
