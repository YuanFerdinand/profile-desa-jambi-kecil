...
class AddDataKesenian extends StatefulWidget {
  @override
  _AddDataKesenianState createState() => _AddDataKesenianState();
}

class _AddDataKesenianState extends State<AddDataKesenian> {
  var deskController;
  var namaController;
  var imagePath;
  var imageDir;
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () async {
                                ...
                                DatabaseMethods()
                                    .addDataKesenian(random, addData);
                              },
                              child: Container(
                                decoration: BoxDecoration(
                                  color: Color(0xff008000),
