...
class DetailKebudayaan extends StatefulWidget {
  ...
  @override
  _DetailKebudayaanState createState() => _DetailKebudayaanState();
}

class _DetailKebudayaanState extends State<DetailKebudayaan> {
        ...
        actions: [
          ...
          (myUserName != "USERNAME")
              ? Padding(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      DatabaseMethods().deleteDataKebudayaan(widget.id);
