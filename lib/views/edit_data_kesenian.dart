...
class EditDataKesenian extends StatefulWidget {
  ...
  @override
  _EditDataKesenianState createState() => _EditDataKesenianState();
}

class _EditDataKesenianState extends State<EditDataKesenian> {
  var imagePath;
  var deskController;
  var namaController;
  var imageDir;
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () async {
                                ...
                                DatabaseMethods()
                                    .updateDataKesenian(widget.id, updateInfo);
                              },
                              child: Container(
                                decoration: BoxDecoration(
                                  color: Color(0xff008000),
