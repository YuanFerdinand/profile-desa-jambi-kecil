...
import 'package:profile_desa_jambi_kecil/views/edit_data_makanan.dart';
        ...
        actions: [
          ...
          (myUserName != "USERNAME")
              ? Padding(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      DatabaseMethods().deleteDataMakanan(widget.id);
            ...
            child: ListView(
              children: [
                ...
                Padding(
                  ...
                  child: Center(
                      child: Text(
                    "Gambar Makanan Khas " + widget.nama,
                    style: TextStyle(fontWeight: FontWeight.bold),
                  )),
                ),
                Padding(
